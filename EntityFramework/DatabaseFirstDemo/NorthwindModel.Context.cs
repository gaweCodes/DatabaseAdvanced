...
namespace DatabaseFirstDemo
{
    ...
    public partial class NorthwindDB : DbContext
    {
        ...
        public virtual ObjectResult<Sales_by_Year_Result> SalesByYear(Nullable<System.DateTime> beginning_Date, Nullable<System.DateTime> ending_Date)
        {
            var beginning_DateParameter = beginning_Date.HasValue ?
                new ObjectParameter("Beginning_Date", beginning_Date) :
                new ObjectParameter("Beginning_Date", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sales_by_Year_Result>("SalesByYear", beginning_DateParameter, ending_DateParameter);
        }
